...
@NgModule({
  imports: [RouterModule.forRoot([{ path: 'products/:category', component: FilteredProductsListComponent }, { path: 'products', component: FilteredProductsListComponent }, { path: 'sorted-products', component: SortedProductsListComponent }, { path: 'employees-list', component: EmployeesListComponent }, { path: 'beers-with-pagination', component: BeersPaginationComponent }, { path: 'refresh-products', component: ProductsListComponent }]), FilteredProductsListComponentModule, CategoriesServiceModule, ProductsServiceModule, SortedProductsListComponentModule, EmployeesListComponentModule, EmployeesServiceModule, BeersPaginationComponentModule, BeerServiceModule, ProductsListComponentModule],
